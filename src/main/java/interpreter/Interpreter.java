                                       ...
                                       new CompStmt(new NewStmt("v1", new ValueExp(new IntValue(2))),
                                               new CompStmt(new NewStmt("v2", new ValueExp(new IntValue(3))),
                                                       new CompStmt(new NewStmt("v3", new ValueExp(new IntValue(4))),
                                                               new CompStmt(new newLatchStatement("cnt", new HeapReadingExp(new VarExp("v2"))),
                                                                       new CompStmt(new ForkStmt(
                                                                               ...
                                                                               new CompStmt(new ForkStmt(
                                                                                       new CompStmt( new HeapWritingStmt("v2", new ArithExp(new HeapReadingExp(new VarExp("v2")), new ValueExp(new IntValue(10)), 3) ),
                                                                                           ...
                                                                                           new CompStmt(new ForkStmt(
                                                                                                   new CompStmt( new HeapWritingStmt("v3", new ArithExp(new HeapReadingExp(new VarExp("v3")), new ValueExp(new IntValue(10)), 3) ),
