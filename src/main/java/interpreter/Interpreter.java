                                         ...
                                         new CompStmt( new ForkStmt(
                                                 new CompStmt( new AcquireStmt("cnt"),
                                                         new CompStmt(new HeapWritingStmt("v1", new ArithExp(new HeapReadingExp(new VarExp("v1")), new ValueExp(new IntValue(10)), 3)),
                                                                 new CompStmt(new PrintStmt(new HeapReadingExp(new VarExp("v1"))), new ReleaseStmt("cnt")))) ),
                                                 new CompStmt(new ForkStmt(

                                                         new CompStmt(new AcquireStmt("cnt"),
                                                                 new CompStmt(new HeapWritingStmt("v1", new ArithExp(new HeapReadingExp(new VarExp("v1")), new ValueExp(new IntValue(10)), 3)),
                                                                         new CompStmt(new HeapWritingStmt("v1", new ArithExp(new HeapReadingExp(new VarExp("v1")), new ValueExp(new IntValue(2)), 3)),
                                                                                 new CompStmt(new PrintStmt(new HeapReadingExp(new VarExp("v1"))), new ReleaseStmt("cnt")))))),
                                                         new CompStmt(new AcquireStmt("cnt"),
                                                                 new CompStmt(new PrintStmt( new ArithExp( new HeapReadingExp(new VarExp("v1")), new ValueExp(new IntValue(1)), 2 ) ),
                                                                         new ReleaseStmt("cnt")))
