...
public class Interpreter {
     public static List<IStmt> getPrgStates() throws MyException {
         ...
         IStmt assigningV = new AssignStmt("v", new ValueExp(new StringValue("C:\\Users\\doria\\IdeaProjects\\InterpreterWithUICyclicBarrier\\src\\main\\in.txt")));
                                                         ...
                                                         new CompStmt(new NewBarrierStmt("cnt", new HeapReadingExp(new VarExp("v2"))),
                                                                 new CompStmt(new ForkStmt(
                                                                         ...
                                                                         new CompStmt(new AwaitStmt("cnt"),
                                                                                 new CompStmt(
                                                                                         new HeapWritingStmt("v1", new ArithExp( new HeapReadingExp(new VarExp("v1")), new ValueExp(new IntValue(10)), 3 ) ),
