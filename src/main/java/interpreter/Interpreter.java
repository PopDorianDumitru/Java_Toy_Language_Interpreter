                                                                 ...
                                                                 new CompStmt(new ForkStmt(
                                                                         new CompStmt(new ForkStmt(
                                                                                 new CompStmt(new LockStmt("x"),
                                                                                         new CompStmt(new HeapWritingStmt("v1", new ArithExp(new HeapReadingExp(new VarExp("v1")), new ValueExp(new IntValue(1)), 2 )),
                                                                                                 new UnlockStmt("x")))
                                                                         ),
                                                                                 new CompStmt(new LockStmt("x"),
                                                                                         new CompStmt(new HeapWritingStmt("v1", new ArithExp(new HeapReadingExp(new VarExp("v1")), new ValueExp(new IntValue(10)), 3 )),
                                                                                                 new UnlockStmt("x"))))
                                                                 ),
                                                                                 ...
                                                                                 new CompStmt(new ForkStmt(
                                                                                         new CompStmt(new ForkStmt(
                                                                                                 new CompStmt(new LockStmt("q"),
                                                                                                         new CompStmt( new HeapWritingStmt("v2", new ArithExp(new HeapReadingExp(new VarExp("v2")), new ValueExp(new IntValue(5)), 1 )),
                                                                                                                 new UnlockStmt("q")))
                                                                                         ),
                                                                                                 new CompStmt(new LockStmt("q"),
                                                                                                         new CompStmt( new HeapWritingStmt("v2", new ArithExp(new HeapReadingExp(new VarExp("v2")), new ValueExp(new IntValue(10)), 3 )),
                                                                                                                 new UnlockStmt("q"))))
                                                                                 ),
