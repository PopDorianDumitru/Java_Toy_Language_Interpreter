...
public class ForkStmt implements IStmt{
    ...
    public PrgState execute(PrgState state) throws MyException {
        ...
        MyIStack<MyIDictionary<String, Value>> dicts = state.getCloneTables();
        System.out.println(dicts);
        return new PrgState(newExeStack, dicts, state.getOut(), state.getFileTable(), state.getHeap(), state.getProcTable());
    }
